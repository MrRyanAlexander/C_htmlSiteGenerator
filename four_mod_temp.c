...
void genFourTemp(SITE site) {
    ...
    strcat(url, ".php");      //concat the new directory name with the prefix
    ...
    fprintf(file,
        ...
        "            <tr>\n"
        "                <td>\n"
        "                   <a href=\"http://amatuerslivewebcams.com/%s.php\">%s</a>\n"
        "               </td>\n"
        "                <td>\n"
        "                   <a href=\"http://amatuerslivewebcams.com/%s.php\">%s</a>\n"
        "               </td>\n"
        ...
        "  ga('send', 'pageview');\n"
        "</script>\n"
        "</html>", site.keyword, site.ethnicity, site.sexPref, site.gender, site.bodyType , site.title, site.description, site.keywords, site.title,site.urls[0],site.urlsTitles[0],site.urls[1],site.urlsTitles[1],site.urls[2],site.urlsTitles[2],site.urls[3],site.urlsTitles[3],site.urls[4],site.urlsTitles[4],site.urls[5],site.urlsTitles[5]);
